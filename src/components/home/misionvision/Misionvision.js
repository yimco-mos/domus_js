...
import { quienesSomos, mision, vision } from "@/textos/misionvision.text";
    ...
    <div className="content_misionv justify-center">
      <div className="img_bjs flex">
        ...
        <div className="imgs_objs block">
          ...
          <div className="vision_dec m-4 pb-4 mb-6">
            <div className="vision_t py-2">
              <h4>{visionKeys}</h4>
            </div>
            <div className="vision_txt">
              <p className="text-neutral-950 p-2">{vision.vision}</p>
            </div>
          </div>
        </div>
      </div>
